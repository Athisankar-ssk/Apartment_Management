...
function LiftComplaint() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setIsError(false);
      setFormData({ category: "Lift", subject: "", description: "", urgency: "medium" });
    } catch (err) {
    ...
    <>
      ...
      <div className="admin-dashboard">
        <header className="admin-header">
          <h1>Lift Complaint</h1>
        </header>

        <div className="create-card card">
          <h3>Register Lift Complaint</h3>
            ...
            <div className="form-grid">
              ...
              <div className="form-group" style={{ gridColumn: "1 / -1" }}>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  placeholder="Detailed description of the lift issue"
                  rows="5"
                  required
                />
              </div>
