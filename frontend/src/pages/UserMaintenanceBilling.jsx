...
function UserMaintenanceBilling() {
  ...
  const fetchUserProfile = async () => {
    try {
      ...
      // Fetch maintenance bills for this user
      const billsRes = await axios.get(`http://localhost:5000/api/billing/maintenance/user/${userId}`, {
        headers: { Authorization: `Bearer ${token}` }
      });
    ...
    return (
      <>
        ...
        <div className="billing-container">
          <p className="loading">Loading your maintenance bills...</p>
        </div>
      </>
    );
  }
    ...
    <>
      ...
      <div className="billing-container">
        <header className="billing-header">
          <h1>My Maintenance Bills</h1>
          <p>View and track your monthly maintenance charges</p>
        </header>
        ...
        <div className="billing-content">
          <div className="bill-section">
            <div className="section-header">
              <h2>Monthly Maintenance Bill History</h2>
            </div>
        ...
        {bills.some(bill => bill.status === 'Unpaid' || bill.status === 'Overdue') && (
          <div className="payment-notice">
            ...
            <p>You have unpaid maintenance bills. Please contact the apartment office for payment details.</p>
          </div>
        )}
      </div>
    </>
...
export default UserMaintenanceBilling;
